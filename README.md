...
### Instrucciones
Teniendo ya algún servidor sirviendo (valga la redundancia) el index, ahí se podrá ver el menú principal de todo el juego, que mostrará: el tablero, el puntaje más alto alcanzado y el botón de comenzar justo debajo del tablero. Para jugar, simplemente se debe de presionar ese último botón y automáticamente empezará el juego. Únicamente se detendrá hasta que el jugador choque contra sí mismo, choque contra una pared o bien gane el juego haciendo que la serpiente ocupe toda la longitud posible del tablero.
